...
![A micrometer screw gauge showing the main scale sleeve, thimble scale, and ratchet, with measuring faces labelled A and B](/handout-media/a_level_physics/assets/01-p25-micrometer-screw-gauge.png)
*A micrometer screw gauge measures to the nearest 0.01 mm*

![Two micrometer scale diagrams: a shows the zero reading with the scale near 45; b shows a measurement reading with the thimble scale offset](/handout-media/a_level_physics/assets/01-p26-micrometer-scale-reading.png)
...
![An ammeter with its needle resting below the zero mark, showing a systematic zero error of about minus 0.2 A](/handout-media/a_level_physics/assets/01-p30-zero-error-ammeter.png)
*An ammeter with a zero error: the needle reads below zero before any current flows*

![A ruler viewed from three different angles showing how the apparent reading changes with viewing angle, illustrating parallax error](/handout-media/a_level_physics/assets/01-p30-parallax-error.png)
...
![Two distribution curves: curve a shows a narrow tall peak centred on the true value T, labelled precise and accurate; curve b shows a wide low peak also centred on T, labelled imprecise but accurate](/handout-media/a_level_physics/assets/01-p27-precision-distribution.png)
...
![Two distribution curves showing precision vs accuracy: curve a has a narrow peak offset from T, labelled precise but not accurate; curve b has a wide peak also offset from T, labelled imprecise and not accurate](/handout-media/a_level_physics/assets/01-p27-accuracy-distribution.png)
...
![Two velocity vectors drawn as arrows to scale, with a north reference line: arrow a points due east labelled 15 metres per second; arrow b points due south labelled 10 metres per second](/handout-media/a_level_physics/assets/01-p36-vector-representation.png)
...
![Diagrams showing vector addition and subtraction: row a shows 20 N up plus 30 N up equals 50 N up; row b shows 20 N up minus 30 N down gives 10 N downward resultant](/handout-media/a_level_physics/assets/01-p36-vector-addition-subtraction.png)
...
![A diagonal force F at angle theta to the horizontal, with a dashed horizontal arrow labelled FH and a dashed vertical arrow labelled FV showing the two perpendicular components](/handout-media/a_level_physics/assets/01-p39-vector-resolution-components.png)
