...
![A displacement x drawn horizontally with a force F acting at an angle theta below it; the work done uses the component of F along x](/handout-media/a_level_physics/assets/05-p104-work-force-at-angle.png)
*Only the component of the force along the displacement (F cos θ) does work*
...
![Two diagrams: when the force points along the direction of movement, work is done by the force; when the force points opposite to the movement, work is done on the force](/handout-media/a_level_physics/assets/05-p104-positive-negative-work.png)
*Work done by the force (top) and work done on the force (bottom)*
