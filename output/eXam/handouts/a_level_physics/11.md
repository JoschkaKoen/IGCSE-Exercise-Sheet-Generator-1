...
![The alpha-scattering apparatus: an alpha source and a thin gold foil inside an evacuated chamber, with a zinc sulfide detector on a microscope that can be moved to different angles](/handout-media/a_level_physics/assets/11-p222-alpha-scattering-experiment.png)
*The α-scattering experiment — α-particles strike a thin gold foil in a vacuum*

![Paths of alpha particles near a gold nucleus: most pass almost straight through, some are deflected through small angles, and a rare one approaching head-on is turned back at its closest approach](/handout-media/a_level_physics/assets/11-p223-alpha-particle-trajectories.png)
*Most α-particles pass nearly straight through; a few are deflected sharply by the tiny nucleus*
...
![Two atom models: a) a helium atom with two protons and two neutrons in the nucleus and electrons on one shell, b) a lithium atom with a larger nucleus and electrons on two shells](/handout-media/a_level_physics/assets/11-p213-atom-structures.png)
