...
![A glancing collision: an incoming particle of mass m moving along the x-axis strikes a stationary particle; the two move off at angles phi and beta above and below the x-axis with velocities v1 and v2](/handout-media/a_level_physics/assets/03-p82-glancing-collision.png)
