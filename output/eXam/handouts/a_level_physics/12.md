...
![A circle with a sector marked; the radius r and an arc of length s bound an angle theta at the centre, equal to 1 radian when the arc length equals the radius](/handout-media/a_level_physics/assets/12-p239-radian-definition.png)
...
![An object moving round a circle of radius r; as the radius sweeps through an angle Δθ the object moves along an arc Δs, and its velocity v points along the tangent](/handout-media/a_level_physics/assets/12-p240-angular-speed.png)
*As the radius turns through Δθ the object moves an arc Δs at speed v*
...
![A ball moving along a circular path: its velocity points along the tangent while the force and acceleration point inwards towards the centre](/handout-media/a_level_physics/assets/12-p241-centripetal-direction.png)
...
![A car on a banked track; the resultant force F of the road on the car resolves into a vertical part F_v balancing the weight and a horizontal part F_h pointing to the centre of the circle](/handout-media/a_level_physics/assets/12-p243-banked-corner.png)
...
![A person on a circular ride drawn at the top and bottom of the loop; at the top the weight W and normal contact force R_t both point down, at the bottom the normal contact force R_b points up and the weight W points down](/handout-media/a_level_physics/assets/12-p244-vertical-circle-forces.png)
