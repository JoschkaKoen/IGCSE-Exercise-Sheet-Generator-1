...
For two slits a distance $a$ apart, with a screen a distance $D$ away (assume $D \gg a$), light of wavelength $\lambda$ makes fringes on the screen. The **fringe spacing** 条纹间距 $x$ (one **fringe** 条纹 to the next) is
