...
![Two cylinders side by side showing positive and negative charge carriers moving with drift velocity v, cross-section A, with conventional current I indicated](/handout-media/a_level_physics/assets/09-p179-drift-velocity-conductor.png)
...
![I–V graph for an ohmic conductor: straight line through origin in both directions](/handout-media/a_level_physics/assets/09-p184-iv-constantan-wire.png)
*I–V characteristic of an ohmic conductor (metal wire at constant temperature)*

![I–V graph for a filament lamp: S-shaped curve through origin, flattening at high voltage](/handout-media/a_level_physics/assets/09-p184-iv-filament-lamp.png)
*I–V characteristic of a filament lamp*

![I–V graph for a diode: flat near zero, rising sharply above 0.5 V, with diode circuit symbol](/handout-media/a_level_physics/assets/09-p184-iv-diode.png)
...
![A waiter carrying a tray navigating through a long crowd-filled room, illustrating how longer length means more resistance](/handout-media/a_level_physics/assets/09-p186-resistivity-length.png)
*A longer conductor has more resistance — more collisions along the way*

![A waiter carrying a tray navigating through a wide crowd-filled room, illustrating how larger cross-section means less resistance](/handout-media/a_level_physics/assets/09-p186-resistivity-area.png)
*A wider conductor has less resistance — more parallel paths available*
...
![Log-log graph: resistance in kΩ on y-axis falling from 1000 to 0.1, light intensity in lux on x-axis rising from 0.1 to 10000](/handout-media/a_level_physics/assets/09-p187-ldr-resistance-vs-light.png)
...
![Graph of resistance in ohms vs temperature in degrees Celsius: steeply falling exponential curve from about 3800 Ω at 0°C down to about 650 Ω at 50°C](/handout-media/a_level_physics/assets/09-p188-thermistor-resistance-vs-temp.png)
