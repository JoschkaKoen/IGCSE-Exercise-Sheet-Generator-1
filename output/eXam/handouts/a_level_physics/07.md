...
![Transverse wave on a rope: crests and troughs, with particle motion perpendicular to the direction the energy travels](/handout-media/a_level_physics/assets/07-fig-1-transverse-wave.png)
...
![Longitudinal wave on a slinky spring: compressions and rarefactions, with particle motion parallel to the direction the energy travels](/handout-media/a_level_physics/assets/07-fig-2-longitudinal-wave.png)
...
![The electromagnetic spectrum from radio waves to gamma rays, with frequency and wavelength scales and example applications](/handout-media/a_level_physics/assets/07-fig-3-em-spectrum.png)
