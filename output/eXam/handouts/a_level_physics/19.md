...
![Two capacitors C1 and C2 connected side by side across the same potential difference V, equivalent to a single capacitor C](/handout-media/a_level_physics/assets/19-p322-capacitors-in-parallel.png)
...
![Two capacitors C1 and C2 connected in a line carrying the same charge, with p.d.s V1 and V2 adding to V, equivalent to a single capacitor C](/handout-media/a_level_physics/assets/19-p321-capacitors-in-series.png)
...
![A graph of potential difference against charge: a straight line through the origin, with the area beneath it up to charge Q0 shaded as the stored energy](/handout-media/a_level_physics/assets/19-p324-energy-qv-graph.png)
*The energy stored is the area under the potential–charge line (the triangle ½QV)*
...
![A circuit with a supply of e.m.f. V0, a two-way switch with positions A and B, a capacitor and a resistor in series with an ammeter; position A charges the capacitor and position B discharges it through the resistor](/handout-media/a_level_physics/assets/19-p325-discharge-circuit.png)
...
![A graph of charge against time during discharge: an exponential decay curve starting at Q0 and falling to Q0/e at time equal to RC](/handout-media/a_level_physics/assets/19-p326-discharge-decay-curve.png)
*Charge decays exponentially during discharge, falling to Q₀/e after one time constant RC*
