...
![Payroll and Sales programs each with their own data files and record structures](/handout-media/a_level_computer_science/assets/08-p214-file-based-approach.png)
...
![A DBMS holding tables design, validation rules, access rights and data, shared by the payroll and sales applications](/handout-media/a_level_computer_science/assets/08-p215-database-approach.png)
...
![An E-R diagram with a Student entity and a Class entity joined by a one-to-many relationship line](/handout-media/a_level_computer_science/assets/08-p218-er-diagram.png)
*An E-R diagram: one class has many students*

![Crow's-foot line symbols for one, many, one and only one, zero or one, one or many, and zero or many](/handout-media/a_level_computer_science/assets/08-p218-cardinality-notation.png)
