...
![A class diagram box headed Shape, with private attributes Name, Area, Perimeter and public methods SetShape, calculateArea, calculatePerimeter](/handout-media/a_level_computer_science/assets/20-p517-class-diagram.png)
*A class diagram for a Shape: private attributes and public methods*

![An inheritance diagram: the employee class at the top, with partTime and fullTime subclasses each adding their own attributes and methods](/handout-media/a_level_computer_science/assets/20-p525-inheritance.png)
