...
![Block diagram of the Von Neumann CPU showing PC, MAR, MDR, CIR, ACC, status registers, control unit and ALU, linked to the address, data and control buses](/handout-media/a_level_computer_science/assets/04-p125-von-neumann-architecture.png)
...
![CPU, memory and input/output connected through the control bus, address bus and data bus](/handout-media/a_level_computer_science/assets/04-p128-system-buses.png)
...
![Flowchart of the fetch-execute cycle from START, fetching via the PC, MAR, MDR and CIR, incrementing the PC, decoding and executing, then checking for interrupts](/handout-media/a_level_computer_science/assets/04-p133-fetch-execute-cycle.png)
...
![Three-column flowchart showing the fetch stage, execute stage and interrupt stage of the cycle](/handout-media/a_level_computer_science/assets/04-p134-interrupt-process.png)
