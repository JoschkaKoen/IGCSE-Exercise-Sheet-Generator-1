...
![Plaintext goes through an encryption algorithm with a key to ciphertext, across the internet, then a decryption algorithm with a key back to plaintext](/handout-media/a_level_computer_science/assets/17-p427-encryption-process.png)
...
![Tom and Meera each have a public and private key; Meera sends Tom her public key](/handout-media/a_level_computer_science/assets/17-p429-asymmetric-keys.png)
...
![A client sends a request to a Certificate Authority, which verifies the identity and issues a digital certificate containing the public key, CA identification, user id, digital signature and other information](/handout-media/a_level_computer_science/assets/17-p437-digital-certificate.png)
...
![The sender hashes a document and encrypts the digest with their private key to form a signature; the receiver hashes the document and decrypts the signature with the public key, then compares the two digests](/handout-media/a_level_computer_science/assets/17-p436-digital-signature.png)
