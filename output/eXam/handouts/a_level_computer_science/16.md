...
![A timeline bar showing P1 then P2, P3, P4 run one after another from time 0 to 39](/handout-media/a_level_computer_science/assets/16-p395-scheduling-fcfs.png)
...
![A cycle diagram: new program to ready, ready to running via the scheduler, running to ready on interrupt, running to blocked on I/O, blocked back to ready, running to terminated](/handout-media/a_level_computer_science/assets/16-p394-process-states.png)
...
![Logical-memory pages mapped through a page table to physical-memory frames](/handout-media/a_level_computer_science/assets/16-p400-paging.png)
...
![Logical segments mapped through a segment map table of sizes and start addresses to physical memory](/handout-media/a_level_computer_science/assets/16-p400-segmentation.png)
...
![A railroad diagram: assignment goes through a variable box, an equals sign, a variable, an operator and a variable](/handout-media/a_level_computer_science/assets/16-p415-syntax-diagram.png)
