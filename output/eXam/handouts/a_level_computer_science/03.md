...
![Cutaway of a microphone: sound waves hit a diaphragm linked to a coil around a permanent magnet, giving an output current](/handout-media/a_level_computer_science/assets/03-p97-microphone.png)
*Inside a microphone: sound vibrates the diaphragm and coil to produce a current*

![Cutaway of a loudspeaker: current in a coil around an iron core near a permanent magnet moves a paper cone to produce sound waves](/handout-media/a_level_computer_science/assets/03-p96-loudspeaker.png)
...
![A hard disk platter drawn as concentric track circles, one track highlighted, divided into sectors](/handout-media/a_level_computer_science/assets/03-p89-hdd-tracks-sectors.png)
...
![Flowchart: sensors send signals through an ADC to the processor, which either reports a warning for monitoring or sends signals to actuators in a feedback loop for control](/handout-media/a_level_computer_science/assets/03-p102-monitoring-control-feedback.png)
...
![The circuit symbols for NOT, AND, OR, NAND, NOR and XOR gates in a two-by-three grid](/handout-media/a_level_computer_science/assets/03-p105-six-logic-gates.png)
...
![A logic circuit with two AND gates, each fed by a NOT gate, combined by an OR gate to give output X](/handout-media/a_level_computer_science/assets/03-p111-logic-circuit-example.png)
