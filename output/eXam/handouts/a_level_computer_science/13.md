...
![Six record boxes labelled first to sixth, then and so on, marked Start of file](/handout-media/a_level_computer_science/assets/13-p324-serial-file.png)
*Serial file: records are kept in the order they were added*

![Customer record boxes in sorted key order, marked Start of file](/handout-media/a_level_computer_science/assets/13-p325-sequential-file.png)
*Sequential file: records are sorted by a key field*

![Customer record boxes in scattered order, marked Start of file](/handout-media/a_level_computer_science/assets/13-p325-random-file.png)
...
![A row of mantissa fraction place values from one half down to one over 128, and a row of exponent place values from minus 128 down to 1](/handout-media/a_level_computer_science/assets/13-p329-floating-point-format.png)
