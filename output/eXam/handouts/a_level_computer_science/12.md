...
![Five boxes (Analysis, Design, Coding, Testing, Maintenance) cascading down, each leading to the next](/handout-media/a_level_computer_science/assets/12-p301-waterfall-model.png)
*The waterfall model: each stage is finished before the next begins*

![Boxes labelled first, extended, further extended and final waterfall, with a note that the stages repeat as necessary](/handout-media/a_level_computer_science/assets/12-p302-iterative-model.png)
*The iterative model: repeated passes refine the program*

![Three teams each running Analysis to Maintenance in parallel](/handout-media/a_level_computer_science/assets/12-p302-rad-model.png)
...
![A structure chart with Convert temperature at the top and INPUT, Convert to Celsius and OUTPUT modules below, with temperature parameters on the links](/handout-media/a_level_computer_science/assets/12-p304-structure-chart.png)
...
![A state diagram: Locked to Waiting for second digit to Waiting for third digit to Unlocked, with correct-digit and wrong-digit transitions](/handout-media/a_level_computer_science/assets/12-p309-state-transition.png)
