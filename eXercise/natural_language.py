...
- If the request clearly refers to at least one of these subjects: Physics (including IGCSE Physics, 0625), Computer Science (including CS, computing, IGCSE CS, 0478/0984), Mathematics (including maths, math), Biology (including bio, IGCSE Biology, 0610), Chemistry (including chem, IGCSE Chemistry, 0620), Business Studies (including business, IGCSE Business Studies, 0450), Economics (including econ, IGCSE Economics, 0455), A-Level Physics (including A-Level Phys, A level Physics, 9702), A-Level Biology (including A-Level Bio, A level Biology, 9700), A-Level Chemistry (including A-Level Chem, A level Chemistry, 9701), A-Level Computer Science (including A-Level CS, A level CS, 9618), A-Level Business (including A-Level Business, A level Business, 9609), A-Level Economics (including A-Level Econ, A level Economics, 9708), A-Level Mathematics (including A-Level Maths, A level Mathematics, 9709), or A-Level Further Mathematics (including A-Level Further Maths, A level Further Mathematics, 9231) — AND it gives enough to identify at least one exam paper or session (e.g. paper 21/22/41, w24/s25/m25, June 2023, November 2024, 0580, "question paper", "mark scheme" together with a variant, past paper code) — then respond exactly: {"valid": true}
