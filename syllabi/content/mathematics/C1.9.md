...
| 3 Round answers to a reasonable degree of accuracy in the context of a given problem. | e.g. by writing each number correct to 1 significant figure, estimate the value of $$\frac{41.3}{9.79 \times 0.765}$$. |
