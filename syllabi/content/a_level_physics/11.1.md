...
| 5 understand and use the notation $^A_Z\text{X}$ for the representation of nuclides |  |
...
| 11 represent $\alpha$- and $\beta$-decay by a radioactive decay equation of the form $^{238}_{92}\text{U} \rightarrow {^{234}_{90}\text{Th}} + {_2^4\alpha}$ |  |
