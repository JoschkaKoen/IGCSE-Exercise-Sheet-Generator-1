...
| 2 (a) understand and use rate equations of the form rate = $k [\text{A}]^m[\text{B}]^n$ (for which $m$ and $n$ are 0, 1 or 2) |  |
...
| (b) using the half-life, $t_{1/2}$, and the equation $k = 0.693/t_{1/2}$ |  |
