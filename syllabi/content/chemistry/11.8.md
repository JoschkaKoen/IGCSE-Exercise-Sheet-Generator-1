...
|  | 10 Describe and draw the structure of: (a) nylon, a polyamide [image of nylon structure] (b) PET, a polyester [image of PET structure] The full name for PET, polyethylene terephthalate, is not required |
...
|  | 12 Describe proteins as natural polyamides and that they are formed from amino acid monomers with the general structure: [image of amino acid structure] where R represents different types of side-chain |
|  | 13 Describe and draw the structure of proteins as: [image of protein structure] |
