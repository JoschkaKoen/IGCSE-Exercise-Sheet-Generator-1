...
_SYSTEM_EXAM = _load_prompt("parse_exam_system")[1]
_USER_EXAM = _load_prompt("parse_exam_user_fallback")[1]
_SYSTEM_SCHEME = _load_prompt("parse_scheme_system")[1]
...
# as `{{`/`}}`. Switching to Template `$placeholder` syntax would require
# updating xml_format.py / yaml_format.py / json_format.py at the same time.
_USER_SCHEME = _load_prompt("parse_scheme_user")[1]
_USER_GRAPHICS = _load_prompt("detect_graphics_user")[1]
