...
from xscore.scaffold.pdf_parser.build import build_questions_from_segments
...
from xscore.scaffold.pdf_parser.layout import cell_margin_band, cell_scales
from xscore.scaffold.pdf_parser.regions import (
    clip_for_segment,
