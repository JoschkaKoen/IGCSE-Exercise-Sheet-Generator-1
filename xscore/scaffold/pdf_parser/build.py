...
from xscore.shared.models import BBox, ExamImage, McAnswerOption, Question
...
from xscore.scaffold.pdf_parser.answer_fields import assign_answer_field_bboxes
from xscore.scaffold.pdf_parser.layout import (
    apply_subpage_vertical_snaps,
    cell_margin_band,
    cell_scales,
    expand_bbox_to_subpage_width,
)
from xscore.scaffold.pdf_parser.regions import clip_for_segment, clip_for_text_segment
from xscore.scaffold.pdf_parser.subparts import maybe_split_written_subquestions
