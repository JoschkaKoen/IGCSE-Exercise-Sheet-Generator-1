...
Mark each question below per the SYSTEM rules — fill `assigned_marks`, `explanation`, `confidence`, `problem`. The `transcribed_answer` field is pre-supplied for context; do not alter or re-emit it.
$blueprint
