---
name: parse_mark_scheme_user_yaml
version: v1
description: Step 20 — parse_mark_scheme. User prompt for the YAML-format mark-scheme extraction. {scaffold} is a Python str.format placeholder (NOT Template syntax); literal LaTeX braces are escaped as {{ and }}. Callers do `body.format(scaffold=...)` after loading. Used by xscore.scaffold.formats.yaml_format.YamlScaffoldFormat.build_scheme_user_msg.
---
