...
STEPS: tuple[Step, ...] = (
    ...
    Step(16, "cut_exam_pdf",               writes=("15_detect_exam_layout/split_exam.pdf",)),
    Step(17, "parse_exam_pdf",             writes=("17_parse_exam_pdf/*",)),
    Step(18, "detect_mark_scheme_graphics",writes=("18_parse_mark_scheme/mark_scheme_graphics.*",)),
    Step(19, "parse_mark_scheme",          writes=("18_parse_mark_scheme/mark_scheme.*",)),
